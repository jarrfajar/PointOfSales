        ...
        <ul class="sidebar-menu">
            ...
            <li class="nav-item dropdown {{ $type_menu === 'pembelian' ? 'active' : '' }}">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="{{ Request::is('retur-penerimaan-barang') ? 'active' : '' }}">
                        <a class="nav-link" href="{{ url('retur-penerimaan-barang') }}">Return BAPB</a>
                    </li>
                </ul>
            </li>
            ...
            <li class="{{ Request::is('kasir') ? 'active' : '' }}">
                <a class="nav-link" href="{{ url('kasir') }}"><i class="far fa-square"></i> <span>Kasir</span></a>
            </li>
