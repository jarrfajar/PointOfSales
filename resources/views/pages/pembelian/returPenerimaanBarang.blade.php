...
@section('main')<div class="main-content">
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item"><a href="#">Pemblian</a></div>
                    <div class="breadcrumb-item">Retur BAPB</div>
                </div>
            </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-striped" id="table-retur-bapb">
                                <thead >
                                    <tr>
    ...
    <x-modal name="retur-bapb">
        <div class="row">
            <x-input-select-col name="supplier_id" label="Supplier" style="width: 100%;"></x-input-select-col>
            <x-input-select-col name="nomor_bapb" onchange="changeNomorBapb(this.value)" label="Nomor BAPB" style="width: 100%;"></x-input-select-col>
        </div>

        <div class="row">
            <x-input-select-col name="gudang_id" label="Gudang" style="width: 100%;" readonly></x-input-select-col>
            <x-input-col type="text" name="nomor_faktur" label="Nomor Faktur"  placeholder="AUTO" readonly></x-input-col>
        </div>

        <div class="row">
            <x-input-col type="date" name="tanggal_terima" label="Tanggal Terima" readonly></x-input-col>
            <x-input-col type="text" name="nomor_resi" label="Nomor Resi" readonly></x-input-col>
        </div>
...
@push('scripts')
    ...
    <script src="{{ asset('js/page/pembelian/returPenerimaanBarang.js') }}"></script>
