...
@section('main')<div class="main-content">
        <section class="section">
            ...
            <div class="section-body">
                <div class="card">
                    ...
                    <div class="card-body">
                        <table class="table table-striped" id="table-gudang">
                            <thead >
                                <tr>
    ...
    <div id="modal-gudang" data-focus="false" class="modal fade" role="dialog">
            ...
            <div class="modal-content">
                ...
                <form id="form-gudang">
                    <div class="modal-body">
                        ...
                        <div class="form-group row">
                            <label for="alamat" class="col-sm-3 control-label text-left is-required">Alamat</label>
                            <div class="col-sm-9">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-primary" id="btn-form-gudang">Save</button>
