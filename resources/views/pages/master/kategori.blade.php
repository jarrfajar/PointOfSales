...
@section('main')<div class="main-content">
    ...
    <div id="modal-kategori" data-focus="false" class="modal fade" role="dialog">
            ...
            <div class="modal-content">
                ...
                <form id="form-kategori">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-primary" id="btn-form-kategori">Save</button>
...
@push('scripts')
    ...
    <script src="{{ asset('js/page/master/kategori.js') }}"></script>
